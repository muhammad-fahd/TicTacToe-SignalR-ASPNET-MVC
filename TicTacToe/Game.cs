...
namespace TicTacToe
{
    public class Game : Hub
    {
        ...
        /// </summary>
        private static readonly List<Server.Model.TicTacToe> games = new List<Server.Model.TicTacToe>();
        ...
        public void Play(int position)
        {
            ...
            Clients.Client(game.Player1.ConnectionId).addMarkerPlacement(new GameInfo { OpponentName = player.Name, MarkerPosition = position, Simbolo = player.Simbolo });
            Clients.Client(game.Player2.ConnectionId).addMarkerPlacement(new GameInfo { OpponentName = player.Name, MarkerPosition = position, Simbolo = player.Simbolo });
        ...
        public void FindOpponent()
        {
            ...
            lock (_syncRoot)
            {
                games.Add(new Server.Model.TicTacToe { Player1 = player, Player2 = opponent });
            }
